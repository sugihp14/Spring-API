...
import SpringRestAPI.SpringRestAPI.model.request.CreateContactRequest;
import SpringRestAPI.SpringRestAPI.model.request.UpdateContactRequest;
import SpringRestAPI.SpringRestAPI.model.response.ContactResponse;
...
class ContactControllerTest {
    ...
    void getContactSuccess() throws Exception {
        User user = userRepository.findById("sugih").orElseThrow();
